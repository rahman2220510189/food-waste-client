...
export const NavBar = () => {
    ...
    const navBar = <>
       <NavLink to="/" className={({ isActive }) => isActive ? "text-primary font-medium" : "text-slate-700 hover:text-primary"}>Home</NavLink>
        ...
        <NavLink to="/post" className={({ isActive }) => isActive ? "text-primary font-medium" : "text-slate-700 hover:text-primary"}>Post Food</NavLink>
        <NavLink to="/dashboard" className="text-slate-700 hover:text-primary">Dashboard</NavLink>
